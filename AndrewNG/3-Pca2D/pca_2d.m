...
% Ensuring that the data has (approximately) zero-mean
...
% Computing the eigenvectors of sigma
[u,S,V] = svd(sigma);
...
xHat = u(:,1:k) * xTilde; % recover an approximation 'xHat' to the original value of 'x'
			  % using only 'k' dimensions
...
%  Complete xPCAWhite and plot the results.
